...
<div class="page-content">
                                        ...
                                        <div class="row">
                                            <div id="driver" class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="select2Mobil" style="width: 100% !important;" class="js-example-basic-multiple" name="mobil_id" multiple="multiple">
                                                    </select>
                                                  </div>
                                            </div>
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.bulanannopolgaji.getreport') }}">
  ...
  <script>
     ...
     select2Tahun.select2({
        ...
        $("#pdf").click(function() {
                        ...
                        let url =  "{{ route('backend.bulanannopolgaji.pdf') }}?" +params.toString();
        ...
        $("#excel").click(function() {
                        ...
                        let url =  "{{ route('backend.bulanannopolgaji.excel') }}?" +params.toString();
                        window.open(url, '_blank');
        });
