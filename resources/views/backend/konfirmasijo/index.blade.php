                ...
                <div class="col-md-xl-12">
                    <div class="mt-xl-0 mt-4">
                        <div class="d-flex align-items-start">
                            ...
                            @if(Auth::user()->can('backend-konfirmasijo-create') == 'true')
  ...
  <script>
     ...
     $(document).ready(function () {
        ...
        columns: [
          ...
          {data: 'joborder.mobil.nomor_plat', name: 'joborder.mobil.nomor_plat',  orderable: false, searchable: false},
          {data: 'joborder.driver.name', name: 'joborder.driver.name',  orderable: false, searchable: false},
          {data: 'joborder.ruteawal.name', name: 'joborder.ruteawal.name',  orderable: false, searchable: false},
          {data: 'joborder.ruteakhir.name', name: 'joborder.ruteakhir.name',  orderable: false, searchable: false},
          {data: 'konfirmasi_biaya_lain', name: 'konfirmasi_biaya_lain',  orderable: false, searchable: false},
          {data: 'joborder.rute.ritase_tonase', name: 'joborder.rute.ritase_tonase',  orderable: false, searchable: false},
