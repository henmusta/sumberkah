...
<div class="page-content">
                            ...
                            <div class="col-md-12">
                                <div class="multi-collapse collapse show" id="multiCollapseExample2" style="">
                                    <div class="card border shadow-none card-body text-muted mb-0">
                                        <div class="row">
                                            <div id="customer" class="col-md-3">
                                                <div class="mb-3">
                                                    <label for="select2Customer">Customer<span class="text-danger"></span></label>
                                                    <select style="width: 100% !important;" id="select2Customer" class="js-example-basic-multiple" name="customer_id" multiple="multiple">
                                                    </select>
                                                </div>
                                            </div>
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.bulanancustomerinvoice.getreport') }}">
  ...
  <script>
     ...
     select2Tahun.select2({
        ...
        $("#pdf").click(function() {
                        ...
                        let url =  "{{ route('backend.bulanancustomerinvoice.pdf') }}?" +params.toString();
        ...
        $("#excel").click(function() {
                        ...
                        let url =  "{{ route('backend.bulanancustomerinvoice.excel') }}?" +params.toString();
                        window.open(url, '_blank');
        });
