                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                    <th  class="text-end" colspan="4" class="text-right"><label>Total Pembayaran<span class="text-danger"></span></label></th>
                                                        <th>
                                                            <input id="total_payment"  value="{{ $data['joborder']['total_payment'] }}" name="total_payment" style="font-size: 24px; color:black;" class="form-control text-end" readonly>
                                                        </th>
                                                    <th></th>
                                            </tr>
                                            <tr>
                                                <th  class="text-end" colspan="4" class="text-right"><label>Total Potongan Bon<span class="text-danger"></span></label></th>
                                                    <th>
                                                        <input id="total_kasbon"  value="{{ $data['joborder']['total_kasbon'] }}" name="total_kasbon" style="font-size: 24px; color:black;" class="form-control text-end" readonly>
                                                    </th>
                                                <th></th>
                                           </tr>
                                            <tr>
     ...
     function get_jo(id){
      ...
      const tablePembayaran = $('#Datatable').DataTable({
			...
			rowCallback : function( row, data, displayNum, displayIndex, index ){
                ...
                if(get_kasbon <= 0){
                    $(row).find('#num_nominal_kasbon').prop('readonly', true);
                }else{
                    $(row).find('#num_nominal_kasbon').prop('readonly', false);
                }
      ...
      $('#Datatable').on('changeTotalItem',	function(){
           ...
           let for_sisa_uang_jalan = 0;
            ...
            console.log( total_nominal_kasbon);
            console.log( total_nominal_payment);
            // console.log( get_sisa_uang_jalan);
