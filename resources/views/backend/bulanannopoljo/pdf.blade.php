...
<body>
    ...
    <div class="header" style="padding-bottom: 20px;">
        <h3  style=" text-align: center; margin-top:25px;margin-bottom: 0">Laporan Nopol Joborder</h3>
    ...
    <table id="pakettable" style="{{$cek}}">
        <thead  style="background-color: #fff !important; color:black;" width="100%">
            <tr>
                <th colspan="16" class="text-left">{{$item['mobil']}}</th>
            </tr>
        </thead>
        <thead style="background-color: #fff !important; color:black;">
            <tr>
                ...
                <th width="120px">Operator (Waktu)</th>
            </tr>
        </thead>
        <tbody>
