...
<div class="page-content">
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.bulanannopoljo.getreport') }}">
                ...
                success: function(res) {
                    ...
                    $("#cetak").prop('hidden', false);
                       ...
                       $("#pdf").click(function() {
                            ...
                            let url =  "{{ route('backend.bulanannopoljo.pdf') }}?" +params.toString();
                       ...
                       $("#excel").click(function() {
                            ...
                            let url =  "{{ route('backend.bulanannopoljo.excel') }}?" +params.toString();
                            window.open(url, '_blank');
                       });
