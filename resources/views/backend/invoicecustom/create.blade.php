    ...
    <div class="container-fluid">
      <div class="card">
        <div class="row row-sm">
            <div class="col-12">
                <form id="formStore" action="{{ route('backend.invoicecustom.store') }}" autocomplete="off">
                    @csrf
                                         ...
                                         <th class="text-end" class="text-end">
                                            <div class="d-flex justify-content-end">
                                                <select class="form-select text-end" id="select2Ppn" name="ppn" style="width: 20%">
                                                    <option value="Iya" selected>PPN 11%</option>
                                                    <option value="Tidak">None</option>
                                                </select>
                                            </div>
			...
			columns : [
                {
					...
					render 		: function ( columnData, type, rowData, meta ) {
                        return String(`
							<input id="keterangan` + meta.row + `" class="form-control" value="`+ columnData +`" name="detail[`+ meta.row +`][keterangan]" data-column="keterangan" >
						`).trim();
					}
				},
				{
