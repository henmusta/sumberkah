...
<div class="page-content">
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.rptgaji.getreport') }}">
  ...
  <script>
     ...
     $(document).ready(function () {
        ...
        $("#pdf").click(function() {
                        ...
                        let url =  "{{ route('backend.rptgaji.pdf') }}?" +params.toString();
                        window.open(url, '_blank');

                        // window.location.href = "{{ route('backend.rptgaji.pdf') }}?" +params.toString()
        });
        ...
        $("#excel").click(function() {
                        ...
                        window.location.href = "{{ route('backend.rptgaji.excel') }}?" +params.toString()
        });
