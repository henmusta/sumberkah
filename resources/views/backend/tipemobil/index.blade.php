 ...
 <div class="modal fade" id="modalCreate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="formStore" method="POST" action="{{ route('backend.tipemobil.store') }}">
          @csrf
  ...
  <script>
     ...
     $(document).ready(function () {
      ...
      let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: {
          url: "{{ route('backend.tipemobil.index') }}",
          data: function (d) {
      ...
      modalEdit.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('#formUpdate').setAttribute('action', '{{ route("backend.tipemobil.index") }}/' + event.relatedTarget.getAttribute('data-bs-id'));
      });
      ...
      modalDelete.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('.urlDelete').setAttribute('href', '{{ route("backend.tipemobil.index") }}/' + id);
      });
