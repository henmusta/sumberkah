  ...
  <script>
     ...
     $(document).ready(function () {
      ...
      let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: {
          url: "{{ route('backend.mobilrincian.index') }}",
          data: function (d) {
      ...
      modalDelete.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('.urlDelete').setAttribute('href', '{{ route("backend.mobilrincian.index") }}/' + id);
      });
      ...
      modalValidasi.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('#formUpdateValidasi').setAttribute('action', '{{ route("backend.mobilrincian.validasi") }}');
      });
