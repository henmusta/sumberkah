...
<div class="page-content">
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.bulanandriverjo.getreport') }}">
                ...
                success: function(res) {
                    ...
                    $("#cetak").prop('hidden', false);
                       ...
                       $("#pdf").click(function() {
                            ...
                            let url =  "{{ route('backend.bulanandriverjo.pdf') }}?" +params.toString();
                       ...
                       $("#excel").click(function() {
                            ...
                            let url =  "{{ route('backend.bulanandriverjo.excel') }}?" +params.toString();
                            window.open(url, '_blank');
                       });
