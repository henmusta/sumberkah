    ...
    <div class="container-fluid">
      <div class="card">
        <div class="row row-sm">
            <div class="col-12">
                <form id="formStore" action="{{ route('backend.mobil.store') }}" autocomplete="off">
                    @csrf
                 ...
                 {{-- /   <input type="text" id="mobilrincian_id" name="mobilrincian_id"  class="form-control"/> --}}
                    <div class="card-body">
                        <div class="col-xl-12">
                                            ...
                                            <div class="card border shadow-none card-body text-muted mb-0">
                                                ...
                                                <div class="row">
                                                    <div class="col-12" style="padding-top:30px;">
                                                        <a style="margin:10px;" id="filter" class="btn btn-primary">
                                                            Filter Table
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="nomor_plat" name="nomor_plat"  class="form-control" placeholder="Masukan Nomor Plat"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label>No Rangka<span class="text-danger"></span></label>
                                    <input type="text" id="nomor_rangka" name="nomor_rangka"  class="form-control" placeholder="Masukan Nomor Rangka"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label>No mesin<span class="text-danger"></span></label>
                                    <input type="text" id="nomor_mesin" name="nomor_mesin"  class="form-control" placeholder="Masukan Nomor Mesin"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="nomor_bpkb" name="nomor_bpkb"  class="form-control" placeholder="Masukan Nomor Bpkb"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label>No Stnk<span class="text-danger"></span></label>
                                    <input type="text" id="nomor_stnk" name="nomor_stnk"  class="form-control" placeholder="Masukan Nomor stnk"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label>Masa Berlaku Stnk<span class="text-danger">(1Th)*</span></label>
                                    <input type="text" id="berlaku_stnk" name="berlaku_stnk"  class="form-control" placeholder="Masukan Masa Berlaku Stnk (1th)"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label>Masa Berlaku Stnk<span class="text-danger">(5Th)*</span></label>
                                    <input type="text" id="berlaku_pajak" name="berlaku_pajak"  class="form-control" placeholder="Masukan Masa Berlaku Stnk (5th)"/>
                                  </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="nomor_ijin_usaha" name="nomor_ijin_usaha"  class="form-control" placeholder="Masukan Nomor Ijin Usaha"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="berlaku_ijin_usaha" name="berlaku_ijin_usaha"  class="form-control" placeholder="Masukan Tanggal Berlaku Ijin Usaha"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label>No Kir<span class="text-danger"></span></label>
                                    <input type="text" id="kir" name="kir"  class="form-control" placeholder="Masukan Nomor Kir"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label>Masa Berlaku Kir<span class="text-danger">*</span></label>
                                    <input type="text" id="berlaku_kir" name="berlaku_kir"  class="form-control" placeholder="Masukan Masa Berlaku Kir"/>
                                  </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="nomor_ijin_bongkar" name="nomor_ijin_bongkar"  class="form-control" placeholder="Masukan Nomor Ijin bongkar"/>
                                  </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <span class="text-danger">*</span></label>
                                    <input type="text" id="berlaku_ijin_bongkar" name="berlaku_ijin_bongkar"  class="form-control" placeholder="Masukan Tanggal Berlaku Ijin bongkar"/>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label>Keterangan
                                        <span class="text-danger"></span></label>
                                    <textarea  id="keterangan" name="keterangan"  class="form-control" placeholder="Keterangan" rows="5"></textarea>
                                  </div>
                            </div>
                        </div>
                      </div>
