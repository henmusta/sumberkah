...
<div class="page-content">
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.bulananinvoice.getreport') }}">
  ...
  <script>
     ...
     select2Tahun.select2({
        ...
        $("#pdf").click(function() {
                        ...
                        let url =  "{{ route('backend.bulananinvoice.pdf') }}?" +params.toString();
        ...
        $("#excel").click(function() {
                        ...
                        let url =  "{{ route('backend.bulananinvoice.excel') }}?" +params.toString();
                        window.open(url, '_blank');
        });
