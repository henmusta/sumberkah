...
<div class="page-content">
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.bulanankasbon.getreport') }}">
  ...
  <script>
     ...
     select2Tahun.select2({
        ...
        $("#pdf").click(function() {
                        ...
                        let url =  "{{ route('backend.bulanankasbon.pdf') }}?" +params.toString();
        ...
        $("#excel").click(function() {
                        ...
                        let url =  "{{ route('backend.bulanankasbon.excel') }}?" +params.toString();
                        window.open(url, '_blank');
        });
