...
<div class="page-content">
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.bulananjoborder.getreport') }}">
  ...
  <script>
     ...
     select2Tahun.select2({
        ...
        $("#pdf").click(function() {
                        ...
                        let url =  "{{ route('backend.bulananjoborder.pdf') }}?" +params.toString();
        ...
        $("#excel").click(function() {
                        ...
                        let url =  "{{ route('backend.bulananjoborder.excel') }}?" +params.toString();
                        window.open(url, '_blank');
        });
