    ...
    <div class="container-fluid">
      <div class="card">
        <div class="row row-sm">
            <div class="col-12">
                <form id="formUpdate" action="{{ route('backend.rute.update', Request::segment(3)) }}">
                        ...
                        <div class="row" >
                            <div class="col-md-6" style="border: 1px solid #fff; padding:20px;">
                                 <div class="mb-3">
                                    ...
                                    <select id="select2Customer" style="width: 100% !important;" name="customer_id">
                                        <option value="{{ $data['rute']['customer']['id'] }}"> {{$data['rute']['customer']['name'] }}</option>
                                    </select>
                                  </div>
                                  <div class="mb-3">
                                    <label>Alamat Awal (Dari)<span class="text-danger">*</span></label>
                                        <div class="d-flex">
                                            <select id="select2Firstrute" style="width: 100% !important;" name="first_rute_id">
                                                <option value="{{ $data['rute']['ruteawal']['id'] }}"> {{$data['rute']['ruteawal']['name'] }}</option>
                                            </select>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <div class="d-flex">
                                        <select id="select2Lastrute" style="width: 100% !important;" name="last_rute_id">
                                            <option value="{{ $data['rute']['ruteakhir']['id'] }}"> {{$data['rute']['ruteakhir']['name'] }}</option>
                                        </select>
                                        <a class="btn btn-primary hstack gap-2 align-self-center" data-bs-toggle="modal"
                                        data-bs-target="#modalCreateRute">
                                            <i class="fas fa-plus"></i>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <div class="d-flex">
                                        <select id="select2Muatan" style="width: 100% !important;" name="muatan_id">
                                            <option value="{{ $data['rute']['muatan']['id'] }}"> {{$data['rute']['muatan']['name'] }}</option>
                                        </select>
                                        <a class="btn btn-primary hstack gap-2 align-self-center" data-bs-toggle="modal"
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <div class="d-flex">
                                        <select id="select2Jenis" style="width: 100% !important;" name="jenismobil_id">
                                            <option value="{{ $data['rute']['jenismobil']['id'] }}"> {{$data['rute']['jenismobil']['name'] }}</option>
                                        </select>
                                        <a class="btn btn-primary hstack gap-2 align-self-center" data-bs-toggle="modal"
                            ...
                            <div class="col-md-6" style="border: 1px solid #fff; padding:20px;">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $data['rute']['uang_jalan'] ?? ''}}" id="uang_jalan" name="uang_jalan"  class="form-control" placeholder="Masukan Uang Jalan"/>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="select2RitaseTonase" name="ritase_tonase">
                                      <option value=""></option>
                                      <option {{ $data['rute']['Ritase'] == 0 ? 'selected' : NULL }} value="Ritase">Ritase</option>
                                      <option {{ $data['rute']['Tonase'] == 0 ? 'selected' : NULL }} value="Tonase">Tonase</option>
                                    </select>
                                  </div>
                                <div class="mb-3">
                                    <label>Harga/Satuan<span class="text-danger">*</span></label>
                                    <input type="text" id="harga"  value="{{ $data['rute']['harga'] ?? ''}}" name="harga"  class="form-control" placeholder="Masukan Harga"/>
                                </div>
                                <div class="mb-3">
                                    <label>Gaji<span class="text-danger">*</span></label>
                                    <input type="text" id="gaji"  value="{{ $data['rute']['gaji'] ?? ''}}" name="gaji"  class="form-control" placeholder="Masukan Gaji"/>
                                </div>
                                <div class="mb-3">
                                    <label>Keterangan<span class="text-danger">*</span></label>
                                    <textarea type="text" id="keterangan"  value="{{ $data['rute']['keterangan'] ?? ''}}" name="keterangan"  class="form-control" placeholder="Masukan Keterangan"></textarea>
                                </div>
                            </div>
  ...
  <div class="modal fade" id="modalCreateRute" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="formStoreAlamatrute" method="POST" action="{{ route('backend.alamatrute.store') }}">
          @csrf
  ...
  <div class="modal fade" id="modalCreateMuatan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="formStoreMuatan" method="POST" action="{{ route('backend.muatan.store') }}">
          @csrf
          <div class="modal-body">
            <div id="errorCreate" class="mb-3" style="display:none;">
              <div class="alert alert-danger" role="alert">
