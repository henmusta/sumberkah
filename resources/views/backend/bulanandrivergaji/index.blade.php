...
<div class="page-content">
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.bulanandrivergaji.getreport') }}">
                ...
                success: function(res) {
                    ...
                    $("#cetak").prop('hidden', false);
                       ...
                       $("#pdf").click(function() {
                            ...
                            let url =  "{{ route('backend.bulanandrivergaji.pdf') }}?" +params.toString();
                       ...
                       $("#excel").click(function() {
                            ...
                            let url =  "{{ route('backend.bulanandrivergaji.excel') }}?" +params.toString();
                            window.open(url, '_blank');
                       });
