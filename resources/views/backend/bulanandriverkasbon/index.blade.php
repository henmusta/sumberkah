...
<div class="page-content">
                            ...
                            <div class="col-md-12">
                                <div class="multi-collapse collapse show" id="multiCollapseExample2" style="">
                                    <div class="card border shadow-none card-body text-muted mb-0">
                                        <div class="row">
                                            <div id="driver" class="col-md-3">
                                                <div class="mb-3">
                                                    <label for="select2Driver">Driver<span class="text-danger"></span></label>
                                                    <select style="width: 100% !important;" id="select2Driver" class="js-example-basic-multiple" name="driver_id" multiple="multiple">
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div id="cetak" class="col-md-2 text-end" style="padding-top:30px;">
 ...
 <input type="hidden" id="report-url" value="{{ route('backend.bulanandriverkasbon.getreport') }}">
                ...
                success: function(res) {
                    ...
                    $("#cetak").prop('hidden', false);
                       ...
                       $("#pdf").click(function() {
                            ...
                            let url =  "{{ route('backend.bulanandriverkasbon.pdf') }}?" +params.toString();
                       ...
                       $("#excel").click(function() {
                            ...
                            let url =  "{{ route('backend.bulanandriverkasbon.excel') }}?" +params.toString();
                            window.open(url, '_blank');
                       });
